        ...
        return (
            <tr key={index}>
                ...
                <td>
                    ...
                    {this.props.blockActions ? <small>-</small> : <button title="Excluir" type="button" className="btn btn-danger btn-small" onClick={this.props.delete.bind(this, feedData.numero, this.props.callback)}><Glyphicon glyph="trash"/></button>}
                </td>
            </tr>         
        )
      }, this);
      ...
      <Table striped bordered condensed hover>
        <thead>
          <tr>
            ...
            {/* <th>Etapa/Fase</th> */}
            <th>Especificação</th>
            {/* <th>Indicador Físico Und.</th> */}
            {/* <th>Indicador Físico Qtd.</th> */}
            {/* <th>Duração Início</th> */}
            {/* <th>Duração Término</th> */}
            <th>Ação</th>
            </tr>
        </thead>
        <tbody>
        {(this.props.feedData.length > 0) ? (MetaList) : (<tr><td colSpan="8">Nenhuma meta salva!</td></tr>)}
        </tbody>
      </Table>
//       <FilterableTable
// 	namespace="Meta"
