...
class DotacaoOrcamentariaList extends Component {
...
const fields = [
    ...
    { name: 'especificacao', displayName: "Especificação", inputFilterable: true, exactFilterable: true, sortable: true },
    { name: 'Secretarium.nome', displayName: "Secretaria", inputFilterable: true, exactFilterable: true, sortable: true },
...
//   { name: 'exercicio', displayName: "Exercício", inputFilterable: true, exactFilterable: true, sortable: true },
  { name: 'id', displayName: "Ação", inputFilterable: false, exactFilterable: false, sortable: false, render: renderAction }
    ...
    // let DotacaoOrcamentariaList = this
    //   .props
    //   .feedData
    ...
    return (
      ...
      //   </thead>
      //   <tbody>
      //   {(this.props.feedData.length > 0) ? (DotacaoOrcamentariaList) : (<tr><td colSpan="5">Sem dados cadastrados!</td></tr>)}
      //   </tbody>
      // </Table>
      <FilterableTable
	namespace="Convenio"
  ...
  recordCountName="convenio"
  recordCountNamePlural="convenios"
...
export default DotacaoOrcamentariaList;