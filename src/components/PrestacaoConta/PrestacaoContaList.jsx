...
class PrestacaoContaList extends Component {
...
//   { name: 'exercicio', displayName: "Exercício", inputFilterable: true, exactFilterable: true, sortable: true },
  { name: 'id', displayName: "Ação", inputFilterable: false, exactFilterable: false, sortable: false, render: renderAction }
    ...
    return (
      ...
      //   </thead>
      //   <tbody>
      //   {(this.props.feedData.length > 0) ? (PrestacaoContaList) : (<tr><td colSpan="5">Sem dados cadastrados!</td></tr>)}
      //   </tbody>
      // </Table>
      <FilterableTable
	namespace="Grupo"
...
export default PrestacaoContaList;